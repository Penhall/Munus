...
from .models import UserProfile, ManagerProfile, AnalystProfile, SupportProfile, UploadedFile
...
class ManagerProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'can_manage_users', 'can_assign_roles', 'can_configure_models')
...
class SupportProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'can_reset_passwords', 'can_view_logs', 'can_manage_tickets')
    search_fields = ('user__email',)
